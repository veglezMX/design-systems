...
// Base (all platforms) build - no theme overrides
...
async function build() {
  ...
  try {
    ...
    console.log('  - build/css/variables-light.css');
    console.log('  - build/css/variables-dark.css');
